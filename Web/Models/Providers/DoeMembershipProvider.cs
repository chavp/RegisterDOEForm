...
namespace DoeWeb.Models.Providers
{
    ...
    public class DoeMembershipProvider : ExtendedMembershipProvider
    {
        ISessionFactory _sessionFactory = null;

        public DoeMembershipProvider()
        {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            using (var session = _sessionFactory.OpenSession())
            {
                ...
                var membershipUser = new DoeMembershipUser(
                    "DoeMembershipProvider",
                    fullName,
                    null,
                    user.Email, 
                    null, 
